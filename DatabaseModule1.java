...
AUTOINCREMENT ,NAME TEXT,ROLL 
INTEGER,BRANCH TEXT, SEC TEXT, YEAR 
INTEGER,SEM INTEGER,CONTACT INTEGER,EMAIL 
TEXT,PASSWORD TEXT)");
 }
 @Override
...
String roll, String branch, String sec, 
String year, String sem, String contact, 
